...
<head>
    ...
    <link href="theme/premium/icon-sets/icons/line-icons/premium-line-icons.min.css" rel="stylesheet">
    <link href="theme/premium/icon-sets/icons/solid-icons/premium-solid-icons.min.css" rel="stylesheet">

    <!--Nifty Premium Icon [ DEMONSTRATION ]-->
    <link href="theme/css/demo/nifty-demo-icons.min.css" rel="stylesheet">
            ...
            <div id="navbar-container" class="boxed">
                ...
                <div class="navbar-header">
                    <a href="#" class="navbar-brand">
                        <img src="theme/img/logo.png" alt="Synchro Logo" class="brand-icon">
                        <div class="brand-title">
                            <span class="brand-text">Synchro</span>
                        </div>
                    </a>
                </div>
                <!--================================-->
                                    ...
                                    <div class="nano-content">
                                        <ul class="head-list">
                                            ...
                                            <li class="bg-gray">
                                                <a class="media" href="#">
                                                    <div class="media-left">
                                                        <img class="img-circle img-sm" alt="Profile Picture" src="theme/img/profile-photos/9.png">
                                                    </div>
                                                    <div class="media-body">
                                            ...
                                            <li class="bg-gray">
                                                <a class="media" href="#">
                                                    <div class="media-left">
                                                        <img class="img-circle img-sm" alt="Profile Picture" src="theme/img/profile-photos/3.png">
                                                    </div>
                                                    <div class="media-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 col-md-3">
                                        ...
                                        <ul class="list-unstyled">
                                            <li class="dropdown-header"><i class="pli-file icon-fw"></i> Pages</li>
                                        ...
                                        <div class="col-sm-4 col-md-3">
                                            ...
                                            <!--Mega menu list-->
                                            <ul class="list-unstyled">
                                                <li class="dropdown-header"><i class="pli-mail icon-fw"></i> Mailbox</li>
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <p class="dropdown-header"><i class="pli-file-jpg icon-fw"></i> Gallery</p>
                                            <ul class="list-unstyled list-inline text-justify">

                                                <li class="pad-btm">
                                                    <img src="theme/img/thumbs/mega-menu-2.jpg" alt="thumbs">
                                                </li>
                                                <li class="pad-btm">
                                                    <img src="theme/img/thumbs/mega-menu-3.jpg" alt="thumbs">
                                                </li>
                                                <li class="pad-btm">
                                                    <img src="theme/img/thumbs/mega-menu-1.jpg" alt="thumbs">
                                                </li>
                                                <li class="pad-btm">
                                                    <img src="theme/img/thumbs/mega-menu-4.jpg" alt="thumbs">
                                                </li>
                                                <li class="pad-btm">
                                                    <img src="theme/img/thumbs/mega-menu-5.jpg" alt="thumbs">
                                                </li>
                                                <li class="pad-btm">
                                                    <img src="theme/img/thumbs/mega-menu-6.jpg" alt="thumbs">
                                                </li>
                                            </ul>
                            ...
                            <li class="dropdown">
                                <a id="demo-lang-switch" class="lang-selector dropdown-toggle" href="#" data-toggle="dropdown">
                                    <span class="lang-selected">
                                        <img class="lang-flag" src="theme/img/flags/united-kingdom.png" alt="English">
                                    </span>
                                </a>
                                ...
                                <ul class="head-list dropdown-menu">
                                    ...
                                    <li>
                                        <!--France-->
                                        <a href="#">
                                            <img class="lang-flag" src="theme/img/flags/france.png" alt="France">
                                    ...
                                    <li>
                                        <!--Germany-->
                                        <a href="#">
                                            <img class="lang-flag" src="theme/img/flags/germany.png" alt="Germany">
                                    ...
                                    <li>
                                        <!--Italy-->
                                        <a href="#">
                                            <img class="lang-flag" src="theme/img/flags/italy.png" alt="Italy">
                                    ...
                                    <li>
                                        <!--Spain-->
                                        <a href="#">
                                            <img class="lang-flag" src="theme/img/flags/spain.png" alt="Spain">
                            ...
                            <li id="dropdown-user" class="dropdown">
                                <a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
                                    <span class="pull-right">
                                        <!--<img class="img-circle img-user media-object" src="theme/img/profile-photos/1.png" alt="Profile Picture">-->
                                            ...
                                            <div class="list-group bg-trans">
                                                <a href="#" class="list-group-item">
                                                    <div class="media-left pos-rel">
                                                        <img class="img-circle img-xs" src="theme/img/profile-photos/2.png" alt="Profile Picture">
                                                ...
                                                <a href="#" class="list-group-item">
                                                    <div class="media-left pos-rel">
                                                        <img class="img-circle img-xs" src="theme/img/profile-photos/7.png" alt="Profile Picture">
                                                    </div>
                                                    <div class="media-body">
                                                ...
                                                <a href="#" class="list-group-item">
                                                    <div class="media-left pos-rel">
                                                        <img class="img-circle img-xs" src="theme/img/profile-photos/1.png" alt="Profile Picture">
                                                ...
                                                <a href="#" class="list-group-item">
                                                    <div class="media-left pos-rel">
                                                        <img class="img-circle img-xs" src="theme/img/profile-photos/4.png" alt="Profile Picture">
                                                    </div>
                                                    <div class="media-body">
                                                ...
                                                <a href="#" class="list-group-item">
                                                    <div class="media-left pos-rel">
                                                        <img class="img-circle img-xs" src="theme/img/profile-photos/8.png" alt="Profile Picture">
                                                ...
                                                <a href="#" class="list-group-item">
                                                    <div class="media-left pos-rel">
                                                        <img class="img-circle img-xs" src="theme/img/profile-photos/9.png" alt="Profile Picture">
